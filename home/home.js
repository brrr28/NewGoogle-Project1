...
for(var k = 0; k<= card_list_name.length; k++){
    for (var i = 0; i < dataDevelopInfo.developers.length; i++){
        ...
        //console.log(dataDevelopInfo.developers[i].Hobbie[i])
        ...
        card_list_hobbie[i].innerHTML = `Hobbi: ${dataDevelopInfo.developers[i].Hobbie[1]}, </br>${dataDevelopInfo.developers[i].Hobbie[2]}, </br> ${dataDevelopInfo.developers[i].Hobbie[3]}`
